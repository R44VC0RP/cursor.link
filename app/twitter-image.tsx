...
export default async function Image() {
  ...
  const text = 'cursor.link Create, share, and discover cursor rules Like gist, but for cursor rules. Build a library of AI coding assistants tailored to your workflow. Open Source'
