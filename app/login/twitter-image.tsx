...
export default async function Image() {
  ...
  const text = 'Sign In to cursor.link Access your cursor rules and dashboard Start creating and sharing cursor rules with the community. Join thousands of developers building better AI workflows.'
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Access your cursor rules and dashboard
          </div>
          ...
          >
            Start creating and sharing cursor rules with the community.{'\n'}Join thousands of developers building better AI workflows.
          </div>
        </div>
